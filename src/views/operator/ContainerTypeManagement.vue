...
export default class ContainerTypeManagement extends Vue {
  ...
  public getContainerTypes(): Array<any> {
    return [
      {
        containerTypeName: "Container to 01",
        description: "Nó to",
        tareWeight: 100,
        payloadCapacity: 500,
        cubicCapacity: 100,
      ...
      {
        containerTypeName: "Container to 02",
        description: "Nó to",
        tareWeight: 100,
        payloadCapacity: 500,
        cubicCapacity: 100,
      ...
      {
        containerTypeName: "Container to 03",
        description: "Nó to",
        tareWeight: 100,
        payloadCapacity: 500,
        cubicCapacity: 100,
      ...
      {
        containerTypeName: "Container to 04",
        description: "Nó to",
        tareWeight: 100,
        payloadCapacity: 500,
        cubicCapacity: 100,
      ...
      {
        containerTypeName: "Container to 05",
        description: "Nó to",
        tareWeight: 100,
        payloadCapacity: 500,
        cubicCapacity: 100,
      ...
      {
        containerTypeName: "Container to 06",
        description: "Nó to",
        tareWeight: 100,
        payloadCapacity: 500,
        cubicCapacity: 100,
  ...
  public viewDetail(item: any) {
    this.containerTypeName = item.containerTypeName;
